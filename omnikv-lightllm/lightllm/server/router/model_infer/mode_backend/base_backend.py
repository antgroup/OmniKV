...
from lightllm.models.llama_omnikv.model import LlamaTpPartModel as LlamaOmniKVPartModel
...
class ModeBackend:
    ...
    def init_model(self, kvargs):
        ...
        is_quik_activation_weight_quant = any(
            "quik_activation_weight" in mode_ for mode_ in self.mode
        )
        ...
        try:
            ...
            if is_quik_activation_weight_quant:
                if self.model_type == "llama":
                    ...
                    raise Exception(
                        f"quik_activation_weight_quant can not support {self.model_type}"
                    )
                ...
                if self.model_type == "llama":
                    ...
                    raise Exception(
                        f"weight_activation_quant can not support {self.model_type}"
                    )
                ...
                if self.model_type == "llama":
                    ...
                    raise Exception(
                        f"weight_only_quant can not support {self.model_type}"
                    )
                ...
                elif self.model_type == "llama_omnikv":
                    self.model = LlamaOmniKVPartModel(model_kvargs)
                elif self.model_type == "qwen":
