...
from typing import Tuple, List, AnyStr, Dict, SupportsFloat

ROUGE_SCORER = evaluate.load("/input/fangshuai.fs/LLM_code/tmp/evaluate-main/metrics/rouge")
...
def normalize_zh_answer(s: str) -> str:
    ...
    def remove_punc(text):
        ...
        all_punctuation.update({"</s>", "<|eot_id|>"})
...
if __name__ == "__main__":
    ...
    for task in tasks:
        ...
        try:
            ...
            print("Error!!!", e)
            if not os.environ.get("SHOW_ERROR_DETAIL", False):
                pass
            else:
                raise
